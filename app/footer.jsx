            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-start">
                <div className="text-white text-4xl mb-2">
                  {/* Placeholder SVG for the Logo Icon */}
                  <svg width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-white">
              ...
              <p className="text-sm leading-7 text-justify text-gray-200">
