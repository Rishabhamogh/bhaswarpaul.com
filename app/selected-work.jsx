...
const projects = [
  { id: "01", title: "Partner with NumberDekho", category: "WEB & APP", image: "https://images.unsplash.com/photo-1555421689-492a1880562a?q=80&w=2070&auto=format&fit=crop" },
...
const ProjectCard = ({ project }) => {
  ...
  return (
    <motion.div 
      className="relative group w-[80vw] md:w-[290px] h-[350px] md:h-[400px] flex-shrink-0 cursor-pointer mr-5 snap-start overflow-hidden bg-gray-900"
      ...
      >
        <div className="relative w-full h-full">
          ...
          >
             ...
             <h2 className="text-white text-xl font-black uppercase leading-tight font-mono tracking-tight break-words">
               {`{${project.category}}`}
             </h2>
  ...
  return (
    <section className="bg-white py-24 border-t border-gray-100">
      <div className="container mx-auto px-6 mb-12">
        ...
        <div className="w-24 h-2 bg-[#D92323]"></div>
      </div>
      <div 
        ref={scrollRef}
      ...
      >
        ...
        <div className="min-w-[150px] flex items-center justify-center snap-center">
            <div className="group cursor-pointer flex flex-col items-center gap-4">
                ...
                <span className="text-gray-400 font-bold text-xs tracking-widest uppercase group-hover:text-[#D92323] transition-colors">
                    View All
                </span>
            </div>
        </div>
